...
print("Mean, Median and Mode of Weight is {}, {} and {} respectivtely".format(weight_mean, weight_median, weight_mode))
...
print("{}% of data for height lies in 1 standard deviation".format(len(height_list_of_data_within_1_std_deviation)*100.0/len(height_list)))
print("{}% of data for weight lies in 1 standard deviation".format(len(weight_list_of_data_within_1_std_deviation)*100.0/len(weight_list)))